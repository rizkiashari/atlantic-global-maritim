...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className='w-[15rem] absolute hidden lg:block xl:block -z-10 top-[109rem] left-0'>
        <div className='bg-[#ADADF5] h-5'></div>
        <div className='bg-[#1616A3] h-5'></div>
      </div>
      <div className='w-[15rem] absolute hidden lg:block xl:block -z-10 top-[123rem] left-0'>
        <div className='bg-[#ADADF5] h-5'></div>
        <div className='bg-[#1616A3] h-5'></div>
      </div>
      <div className='container mt-12 mb-6 overflow-y-hidden flex justify-between'>
        <div>
